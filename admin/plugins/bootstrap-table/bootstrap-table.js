...
!function ($) {
	...
	BootstrapTable.LOCALES['en-US'] = {
		formatLoadingMessage: function () {
			return 'Nahrávam, prosím čakajte…';
		},
		formatRecordsPerPage: function (pageNumber) {
			return sprintf('%s riadkov na stranu', pageNumber);
		},
		formatShowingRows: function (pageFrom, pageTo, totalRows) {
			return sprintf('Zobrazené %s - %s z %s riadkov', pageFrom, pageTo, totalRows);
		},
	...
	BootstrapTable.prototype.updateSelected = function () {
		...
		this.$selectAll.add(this.$selectAll_).prop('checked', checkAll).change(); // .trigger('click');
